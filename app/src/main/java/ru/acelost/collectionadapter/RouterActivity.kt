...
import ru.acelost.collectionadapter.benchmark_collection_vm_adapter.CollectionVmAdapterBenchmarkActivity
...
class RouterActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Button>(R.id.button_benchmark_collection_vm_adapter)
                .setOnClickListener { startActivity(Intent(this, CollectionVmAdapterBenchmarkActivity::class.java)) }
